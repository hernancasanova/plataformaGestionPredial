...
public interface BovineDao extends JpaRepository<Bovine,Long>{
  ...
  //List<Collection> resultList = query.getResultList();
	...
	List<String> childrenBovine(Long bovine);
}
